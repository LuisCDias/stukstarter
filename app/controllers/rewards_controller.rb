class RewardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @reward.save
        format.html { redirect_to @project, notice: "Reward #{@reward.name} was successfully created." }
      else
  ...
  def update
    respond_to do |format|
      if @reward.update(reward_params)
        format.html { redirect_to @project, notice: "Reward #{@reward.name} was successfully updated." }
      else
